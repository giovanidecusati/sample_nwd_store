...
namespace BuildingBlock.Core.Domain
{
    ...
    public class ValueObjectBase<TValueObject> : Notifiable, IEquatable<TValueObject> where TValueObject : ValueObjectBase<TValueObject>
    {
        ...
        public bool Equals(TValueObject other)
        {
            ...
            if (publicProperties != null && publicProperties.Any())
                return publicProperties.All(item =>
                {
                    Object objCurrent = item.GetValue(this, null);
                    Object objOther = item.GetValue(other, null);
                    return (objCurrent == null && objOther == null) || (objCurrent != null && objCurrent.Equals(objOther));
                });
